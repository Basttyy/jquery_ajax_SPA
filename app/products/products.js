...
function readProductsTemplate(data, keywords){
    ...
    read_products_html+="<div class='input-group pull-left w-30-pct'>";
        ...
        read_products_html+="<input type='text' value=\"" + keywords + "\" required name='keywords' class='form-control product-search-keywords' placeholder='Search products...' />";
    ...
    if(!(keywords === "")){
        ...
        read_products_html+="<div id='read-products' class='btn btn-primary pull-right m-b-15px read-products-button'>";
        read_products_html+="<span class='glyphicon glyphicon-list'></span> Read Products";
        read_products_html+="</div>";
    }
